...
function TabelaCriarRodape(tabela, dados) {
    ...
    // cell.innerHTML = '<li></li> </a> <a href="#"><li><</li> </a> <input type="text" name="" id=""><a href="#"><li>></li></a><a href="#"><li>>></li></a><li>Mostrando 2 de 2 Registros</li>';
}
//  <tfoot>
// <tr>
//   <th colspan=100%>
...
function buscaEstados(idElemento) {
    ...
    return $.ajax({
        ...
        success: function (dadosCabecalho) {
            preencheOptions(idElemento, JSON.parse(dadosCabecalho));
        }
    });
}
...
function buscaDados(idUser) {
    ...
    return $.ajax({
        ...
        contentType: 'application/json',
        success: function (dadosCabecalho) {
            setFormCampos(prForm, JSON.parse(dadosCabecalho));
        }
    });
}
 ...
 */
function preencheOptions(idElemento, dadosCabecalho) {
    var estados = dadosCabecalho['Estados'];
